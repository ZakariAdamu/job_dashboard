		...
		<div className="pt-[5rem] pb-[3rem] w-[80%] mx-auto ">
			<div className=" h-[60vh] w-full">
				<div className="flex items-center w-[100%] gap-[1rem]">
					{/* content */}
					<div className="mr-10">
						<h1 className="text-[2rem] sm:text-[2.5rem] lg:text-[2.7rem] font-bold text-slate-900">
							The{" "}
						...
						<div className="mt-6">
							<input
								...
								className="px-4 py-[7px] w-full md:w-[80%] lg:w-full xl:w-[85%] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2a363f] focus:border-transparent"
							/>
